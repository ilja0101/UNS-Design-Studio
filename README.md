...
| 🍽️ **Recipe system** | Per-plant recipe lists — switching recipes shifts simulation parameters live |
| 🔌 **MQTT + NATS bridge** | Configurable payload schemas, topic prefixes and publish intervals |
| ⚙️ **Payload Schema Designer** | Design your own message formats — Sparkplug B, ISA-95, PI, InfluxDB and more |
...
![UNS Topic Designer — node properties](docs/TopicTreeDesigner2.JPG)
